...
export const CompanionForm = ({
  ...
  const isLoading = form.formState.isSubmitting; // the form state has this state - issubmitting
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      } else { //if we don't ve the initial data then create a new one.
      ...
      router.refresh(); // so all the ss comps will be updated, once we edit or create a new comapanion in the db
      router.push("/");
    } catch (error) {
      toast({
        variant: "destructive",
